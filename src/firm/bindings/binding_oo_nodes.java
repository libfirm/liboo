...
public class binding_oo_nodes {
	...
	public static enum AnonEnum0 {
		pn_InstanceOf_M(pn_generic.pn_Generic_M.val),
		pn_InstanceOf_res(pn_generic.pn_Generic_other.val),
		pn_InstanceOf_max();
		public final int val;
		...
		public static AnonEnum0 getEnum(int val) {
			for (AnonEnum0 entry : values()) {
				if (val == entry.val)
					return entry;
			}
			return null;
	...
	public static enum AnonEnum1 {
		pn_Arraylength_M(pn_generic.pn_Generic_M.val),
		pn_Arraylength_res(pn_generic.pn_Generic_other.val),
		pn_Arraylength_max();
		public final int val;
		...
		public static AnonEnum1 getEnum(int val) {
			for (AnonEnum1 entry : values()) {
				if (val == entry.val)
					return entry;
			}
			return null;
	...
	public static native Pointer get_InstanceOf_objptr(Pointer node);

	public static native void set_InstanceOf_objptr(Pointer node, Pointer objptr);
	...
	public static native Pointer get_Arraylength_arrayref(Pointer node);

	public static native void set_Arraylength_arrayref(Pointer node, Pointer arrayref);

	public static native boolean is_Arraylength(Pointer node);

	public static native void oo_nodes_init();
}
