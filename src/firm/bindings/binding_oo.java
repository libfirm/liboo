...
public class binding_oo {
	...
	public static enum array_kind_t {
		AK_NO_ARRAY(0),
		...
		public static array_kind_t getEnum(int val) {
			for (array_kind_t entry : values()) {
				if (val == entry.val)
					return entry;
			}
			return null;
	...
	public static native void register_array_type(Pointer type, /* array_kind_t */int array_kind);
}
