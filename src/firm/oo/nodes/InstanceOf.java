...
public class InstanceOf extends Node {
	...
	public static Node create(Node block, Node mem, Node _ptr, firm.Type type) {
		return Node.createWrapper(firm.bindings.binding_nodes.new_r_InstanceOf(block.ptr, mem.ptr, _ptr.ptr, type.ptr));
	}

	public static Node create(Construction cons, Node mem, Node _ptr, firm.Type type) {
		return Node.createWrapper(firm.bindings.binding_nodes.new_r_InstanceOf(binding_ircons.get_r_cur_block(cons.getGraph().ptr), mem.ptr, _ptr.ptr, type.ptr));
	}
	...
	public void setPtr(Node _ptr) {
		firm.bindings.binding_nodes.set_InstanceOf_ptr(this.ptr, _ptr.ptr);
	}
