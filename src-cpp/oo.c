...
bool get_class_omit_vtable(ir_type *classtype)
{
	assert (is_Class_type(classtype));
	oo_type_info *ti = get_type_info(classtype);
	return ti->omit_vtable;
}
void set_class_omit_vtable(ir_type *classtype, bool omit_vtable)
{
	assert (is_Class_type(classtype));
	oo_type_info *ti = get_type_info(classtype);
...
bool get_method_exclude_from_vtable(ir_entity *method)
{
	assert (is_method_entity(method));
	oo_entity_info *ei = get_entity_info(method);
	return ei->exclude_from_vtable;
}
void set_method_exclude_from_vtable(ir_entity *method, bool exclude_from_vtable)
{
	assert (is_method_entity(method));
	oo_entity_info *ei = get_entity_info(method);
