 ...
 * @note RTA requires the analyzed code to be typesafe, meaning objects on which dynamically linked calls are invoked have to be of the static type of the reference or a subclass of it, otherwise the results can be incorrect and can lead to defective programs!
